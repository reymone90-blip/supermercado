<div class="mb-4">
    ...
    <p class="text-muted mb-0"><?= htmlspecialchars($proveedor['nombre']) ?></p>
</div>

<div class="panel" style="max-width:640px;">
    <form method="POST" action="<?= url('proveedores.editar') ?>&id=<?= $proveedor['id'] ?>">
        <div class="row g-3">
            <div class="col-12">
